  ...
  sections: [
    {
      ...
      body: [
        'Loppa is built for membership secretaries, event organisers and association treasurers. That audience decides everything about it. The people filling in a form are members, not customers, and they are often doing it once a year on a phone. The people running it are volunteers as often as they are staff.',
    ...
    },
    {
      heading: 'Who runs it',
      body: [
        `Loppa is operated by ${CONTROLLER}, registered at ${pending('registered address')}.`,
  ...
  sections: [
    {
      ...
      body: [
        'For the answers people give to a form, the organisation that published the form is the controller. They decide what to ask and why. Loppa is their processor and acts on their instructions.',
        'For the accounts of the people who log in to build forms, Loppa is the controller.',
...
const TERMS: LegalDocument = {
  slug: 'terms',
  title: 'Terms',
  lede: 'The agreement between an organisation using Loppa and the company operating it.',
  updated: UPDATED,
  sections: [
    {
    ...
    },
    {
      heading: 'The service',
      body: [
        'Loppa provides form building, event registration, admission documents, check-in, and email sending on behalf of the organisation using it.',
