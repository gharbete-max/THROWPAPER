...
/**
 * English, and the source the other languages are translated from.
 *
 * Every string here is carried across verbatim from the site's previous English literals. That is
 * deliberate: a translation pass is the wrong moment to also rewrite the copy, because then no
 * reviewer can tell which changes were translation and which were somebody's opinion.
 */
export const enGB: SiteCopy = {
  meta: {
    homeTitle: 'Formwork — forms, registrations and the door',
    homeDescription:
  ...
  sections: {
    ...
    featuresTitle: 'Built for the day it is used',
    readMore: 'Read more',
    quotesEyebrow: 'In use',
    quotesTitle: 'What people said afterwards',
    ctaTitle: 'Nothing to install',
    ctaBody:
      'The demo runs on made-up data, sends no email, and forgets everything when it restarts.',
  },
  featurePage: {
    backToAll: 'Everything it does',
    back: 'Back',
