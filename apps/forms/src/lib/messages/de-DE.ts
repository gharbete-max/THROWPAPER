...
export const deDE: Record<MessageKey, string> = {
  ...
  'guided.guess.right': 'Stimmt',
  'guided.guess.sortOf': 'Teilweise',
  'guided.guess.no': 'Nein',
  'guided.flow.start.ask': 'Wofür ist dieses Formular?',
  'guided.flow.start.help': 'Ihre Antwort hilft Loppa, die passenden Fragen vorzuschlagen.',
  'guided.flow.start.signup': 'Anmeldungen',
  'guided.flow.start.signupDetail': 'Veranstaltungen, Kurse und Treffen.',
  'guided.flow.start.collect': 'Informationen sammeln',
  'guided.flow.start.collectDetail': 'Mitglieder, Bestellungen und Bewerbungen.',
  'guided.flow.start.feedback': 'Meinungen einholen',
  'guided.flow.start.feedbackDetail': 'Rückmeldungen, Umfragen und Vorschläge.',
  'guided.flow.start.other': 'Etwas anderes',
  'guided.flow.start.otherDetail': 'Mit einer Frage beginnen und weiter aufbauen.',
  'guided.flow.more.ask': 'Noch eine Frage hinzufügen?',
  'guided.flow.more.help': 'Sie können später jederzeit weitere hinzufügen.',
  'guided.flow.more.yes': 'Ja, noch etwas fragen',
  'guided.flow.more.no': 'Nein, das ist alles',
  'guided.brand.start.ask': 'Soll es wie Ihre Organisation aussehen?',
  'guided.brand.start.help': 'Verwendet Logo und Farben Ihrer Marke.',
  'guided.brand.start.yes': 'Ja, unsere Farben und unser Logo',
  'guided.brand.start.later': 'Später entscheiden',
  'guided.brand.quick.ask': 'Welche Farben soll Ihr Formular haben?',
  'guided.brand.quick.help': 'Sie können sie jederzeit ändern.',
  'guided.brand.quick.minimal': 'Minimal',
  'guided.brand.quick.garden': 'Garten',
  'guided.brand.quick.bold': 'Kräftig',
  'guided.brand.quick.midnight': 'Mitternacht',
  'guided.brand.logoSlot.ask': 'Wo soll Ihr Logo stehen?',
  'guided.brand.logoSlot.help': 'Wählen Sie einen Platz. Auf dem Handy passt es auch.',
  'guided.brand.logoSlot.headerLeft': 'Oben links, neben dem Titel',
  'guided.brand.logoSlot.mastheadCentred': 'Zentriert über dem Titel',
  'guided.brand.logoSlot.cornerWatermark': 'Klein, in der Ecke',
  'guided.brand.logoSlot.footerStrip': 'In einem Streifen unten',
  'guided.brand.logoSlot.sidebarRail': 'In einer Spalte neben dem Formular',
  'guided.brand.logoSlot.cardTop': 'Oben auf der Karte',
  'guided.brand.preview.help': 'So sehen andere Ihr Formular.',
  'guided.text.label.ask': 'Was möchten Sie fragen?',
  'guided.text.label.help': 'Schreiben Sie es so, wie Sie es sagen würden.',
  'guided.text.label.exampleName': 'Ihr Name',
  'guided.text.label.exampleEmail': 'Ihre E-Mail-Adresse',
  'guided.text.label.exampleDay': 'Welcher Tag passt Ihnen?',
  'guided.text.required.ask': 'Müssen alle darauf antworten?',
  'guided.text.required.help': 'Das Formular lässt sich erst nach einer Antwort senden.',
  'guided.text.required.yes': 'Ja, das ist nötig',
  'guided.text.required.no': 'Nein, das ist freiwillig',
  'guided.choice.buttons.ask': 'Möchten Sie Schaltflächen?',
  'guided.choice.buttons.help': 'Mit Schaltflächen wählt man, statt zu tippen.',
  'guided.choice.buttons.no': 'Nein, man tippt eine Antwort',
  'guided.choice.answers.ask': 'Eine Antwort oder mehrere?',
  'guided.choice.answers.help': 'Darf man mehr als eines wählen?',
  'guided.choice.answers.one': 'Nur eine Antwort',
  'guided.choice.answers.many': 'Mehrere Antworten erlaubt',
  'guided.choice.count.ask': 'Wie viele Auswahlmöglichkeiten?',
  'guided.choice.count.help': 'Sie können später welche hinzufügen oder entfernen.',
  'guided.choice.shape.ask': 'Welche Form?',
  'guided.choice.shape.help': 'Die Form jeder Schaltfläche.',
  ...
  'guided.choice.placement.underFull': 'Unter der Frage, volle Breite',
  'guided.choice.placement.row': 'Nebeneinander',
  'guided.choice.preview.help': 'Klicken Sie darauf, um etwas selbst zu ändern.',
  'guided.menu.top.ask': 'Was möchten Sie ändern?',
