 ...
 *
 * Phase 4 sends through Loppa's own provider rather than through Mailer, so the delivery
 * webhook waits for Mailer's bounce and complaint handling in B11. A deferral pointing at a
