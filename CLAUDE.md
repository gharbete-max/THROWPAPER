...
apps/desktop    Loppa for Windows: Forms in an Electron window on an embedded Postgres (PGlite),
                offline first. Part of the Forms product, not a fourth one (docs/adr/0016)
